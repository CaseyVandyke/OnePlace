import { getCompanionGuide } from '../constants/companion-guides';
import '../styles/components/companion-guide.css';
...
const CompanionGuide = ({ guideId, size = 54 }) => {
